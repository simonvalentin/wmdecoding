...
colormap(brewermap(64,'Reds')) % change the colormap
...
title(cb1, 'F')
title('Subj. #1', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
hold on
...
title(cb2, 'F')
title('Subj. #2', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
hold on
...
title(cb3, 'F')
title('Subj. #3', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
hold on
...
title(cb4, 'F')
title('Subj. #4', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
hold on
...
title(cb5, 'F')
title('Subj. #5', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
hold on
...
title(cb6, 'F')
title('Subj. #6', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
hold on
...
title(cb7, 'F')
title('Subj. #7', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
hold on
...
title(cb8, 'F')
title('Subj. #8', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
hold on
...
title(cb9, 'F')
title('Subj. #9', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
hold on

subplot(2,5,10);
cb10 = colorbar('FontSize',15); 
set(cb10,'position',[.909 .11 .01 .3])
title('Subj. #10', 'Units', 'normalized','FontSize', 17, 'fontweight', 'normal')
title(cb10, 'F')
...
for ss=1:10
	...
	e2 = 0 
	e3 = 0 
	map = [0.2902 0.4784 0.7176; 0.9290 0.6940 0.1250; 0.7176 0.2902 0.3843]

	subplot(2,5,ss);l = boundedline(x, y1, e1, x, y2, e2, x, y3, e3, 'alpha')
	set(l, {'color'}, num2cell(map,2));
	l = legend(l, {'load 1','load 4','load 7'}, 'FontSize', 12);
	xlabel('Frequency [Hz]', 'FontSize', 14);
	ylabel('Power [a.u.]', 'FontSize', 14);
	title(strcat('Subj. #', number(ss)),'Units', 'normalized', 'FontSize', 16, 'fontweight', 'normal')
